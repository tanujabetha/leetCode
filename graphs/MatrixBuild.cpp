...
MatrixBuild::MatrixBuild(int nodes, int edges, int flag)
{
    this->nodes = nodes;
    this->flag = flag;
    this->edges = edges;
...
int MatrixBuild::adjacencyMatrix()
{
...
void MatrixBuild::printAdjacencyMatrix()
{
...
void MatrixBuild::printAdjacencyList()
{
    for (int i = 0; i < nodes; i++)
    {
        cout << i << ": ";
